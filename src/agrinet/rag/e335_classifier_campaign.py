"""Run E3.35 full Classifier with strict parent-bound Q1 and R0/R1/R2 recovery."""
...
from agrinet.rag.e335_classifier_full import PROTOCOL


def _configure() -> None:
    base.PROTOCOL = PROTOCOL; base.NEW_PROVENANCE = "new_e335"
    base.REUSED_PROVENANCE = "reused_e322_v3"; base.PROVENANCE_KEY = "e335_provenance"
    base.TRACE_BOUND_Q1 = True
    base.OUTCOME_SCHEMA = "agrinet.e335-classifier-full-outcomes/v1"
    base.CONTINUATION_SCHEMA = "agrinet.e335-classifier-full-continuation/v1"
    base.REPORT_SCHEMA = "agrinet.e335-classifier-full-final-report/v1"
    audit_base.PROTOCOL = PROTOCOL; audit_base.NEW_PROVENANCE = "new_e335"
    audit_base.PROVENANCE_KEY = "e335_provenance"
    audit_base.AUDIT_SCHEMA = "agrinet.e335-classifier-full-artifact-audit/v1"
    audit_base.GATE_SCHEMA = "agrinet.e335-classifier-full-gate/v1"
