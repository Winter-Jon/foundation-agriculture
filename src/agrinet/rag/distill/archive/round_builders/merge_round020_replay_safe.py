...
sources=[Path('outputs/artifacts/datasets/agrinet-rag-sft-round007-merged5-singleimg/data.jsonl'),Path('outputs/artifacts/datasets/agrinet-rag-sft-round019-bilingual-pest-singleimg/data.jsonl')]
rows=[]
seen=set()
...
out=Path('outputs/experiments/rag_sft_iteration/rounds/round_0001/plan/round020_replay_safe_source.jsonl')
