...
from agrinet.rag.distill.catalog_and_isolation import ROOT,evaluation_images,normalized
from agrinet.rag.distill.validate_semantic_quality import semantic_row_errors
