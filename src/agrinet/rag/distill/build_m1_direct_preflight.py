...
from agrinet.data.m1_direct_collection import build_plan, image_sha256
from agrinet.rag.distill.catalog_and_isolation import exposed_images, read_jsonl, write_jsonl
from agrinet.rag.distill.hcv_retrieval_preflight import CURRENT_SFT_SOURCES, FORMAL_618, _row_image
