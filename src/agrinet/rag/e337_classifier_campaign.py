"""Run E3.37 with parent-bound Option-safe Q1 and bounded terminal delivery."""
...
from agrinet.rag.e337_classifier_full import (PROTOCOL,
    TERMINAL_UNKNOWN_DELIVERY_MAX_FRACTION)


def _configure() -> None:
    base.PROTOCOL = PROTOCOL; base.NEW_PROVENANCE = "new_e337"
    base.REUSED_PROVENANCE = "reused_e322_v3"; base.PROVENANCE_KEY = "e337_provenance"
    base.TRACE_BOUND_Q1 = True
    base.TERMINAL_UNKNOWN_DELIVERY_MAX_FRACTION = TERMINAL_UNKNOWN_DELIVERY_MAX_FRACTION
    base.OUTCOME_SCHEMA = "agrinet.e337-classifier-full-outcomes/v1"
    base.CONTINUATION_SCHEMA = "agrinet.e337-classifier-full-continuation/v1"
    base.REPORT_SCHEMA = "agrinet.e337-classifier-full-final-report/v1"
    audit_base.PROTOCOL = PROTOCOL; audit_base.NEW_PROVENANCE = "new_e337"
    audit_base.PROVENANCE_KEY = "e337_provenance"
    audit_base.TERMINAL_UNKNOWN_DELIVERY_MAX_FRACTION = TERMINAL_UNKNOWN_DELIVERY_MAX_FRACTION
    audit_base.AUDIT_SCHEMA = "agrinet.e337-classifier-full-artifact-audit/v1"
    audit_base.GATE_SCHEMA = "agrinet.e337-classifier-full-gate/v1"
