...
from agrinet.research.shared.catalog import ROOT, candidate_labels, exposed_images
from archive.source.rag_distill.build_reconstructive_direct_candidates import isolation_hashes
