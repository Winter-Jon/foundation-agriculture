...
from tools.rag_distill.catalog_and_isolation import exposed_images, read_jsonl, write_jsonl
from tools.rag_distill.hcv_retrieval_preflight import CURRENT_SFT_SOURCES, FORMAL_618, _row_image
