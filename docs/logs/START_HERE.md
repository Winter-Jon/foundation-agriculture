...
- Current strict view: 26 RAG total, 24/32 Stage-A quota usable; Direct is 32/32 valid. Stage A needs 8 Blind standard rows. Luna has accepted English Option (Rounds126/133), Chinese Open (Round131), and Chinese Option (Rounds132/134) Pilots; Round141 is a later accepted Chinese Option/disease row, and Terra Round149 strictly accepts English Option/disease. Closed terminal finalization is strictly accepted in Chinese Option/disease, English Option/pest, and Chinese Option/pest; Round129 remains the fixed local JSON-mode defect and Round130 an ordinary Blind semantic mismatch.
...
Stage-A Option calibration's active default is `gpt-5.6-terra`. Micu SLB endpoint and real-image preflight passed for Round149, whose bounded Pilot strictly accepted with three successful retrievals and zero errors. The runner retains the one public-only, no-tool standard final-contract retry introduced after Round148; its validator is unchanged. The fresh authorized Option reserve now has English pest 2, Chinese disease 1, and Chinese pest 1 candidates; preflight and audit exactly one at a time. Do not freeze, SFT, or formally evaluate without their separate approvals.
