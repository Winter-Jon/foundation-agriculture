...
from tools.rag_distill.run_m1_direct_collection import parse_result, request_deadline, retire_interrupted_requests, system_prompt, write_partial_state
...
def test_collection_continues_other_samples_after_prior_unknown_checkpoint(tmp_path: Path, monkeypatch):
    ...
    def checkpointed(payload, _path, _request):
        ...
        return {"independent_choice": "Truth", "checks": {}}
    monkeypatch.setattr("agrinet.data.m1_direct_runner.execute_request", checkpointed)
