#!/usr/bin/env zsh
# Final fresh Blind-only repair for v5's four remaining RAG rows.
set -euo pipefail
ROOT=$(cd "$(dirname "$0")/../.." && pwd); cd "$ROOT"
RUN_ID=large-20260819-large-012
...
LOG_DIR="outputs/runs/rag/hermes-v2-large012-final-blind-quota/logs"; mkdir -p "$LOG_DIR"
...
print 'large-012 final Blind collection completed.'
