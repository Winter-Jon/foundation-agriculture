#!/usr/bin/env zsh
# Final Blind-only pest repair; open/zh/pest has no Oracle capacity.
set -euo pipefail
ROOT=$(cd "$(dirname "$0")/../.." && pwd); cd "$ROOT"
RUN_ID=large-20260819-large-014
...
LOG_DIR="outputs/runs/rag/hermes-v2-large014-final-blind-pest/logs"; mkdir -p "$LOG_DIR"
