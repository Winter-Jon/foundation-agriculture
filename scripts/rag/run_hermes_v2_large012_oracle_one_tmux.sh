#!/usr/bin/env zsh
# One-target, cap-checked Oracle recovery for the sole open/zh/disease quota gap.
set -euo pipefail
...
OUT="$BASE/collection/oracle-rag-large012-open-zh-disease"
LOG_DIR="outputs/runs/rag/hermes-v2-large012-oracle-one/logs"; mkdir -p "$LOG_DIR"
...
print 'large-012 single-target Oracle recovery completed.'
