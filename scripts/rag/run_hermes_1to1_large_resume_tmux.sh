...
run_task() {
  ...
  local args=(.venv/bin/python -m agrinet.rag.distill.collect_hermes_1to1_v2 --targets "$file" --route "$route" --output-dir "$out" --model gpt-5.6-terra --limit 9999 --offset 0 --request-timeout 120)
