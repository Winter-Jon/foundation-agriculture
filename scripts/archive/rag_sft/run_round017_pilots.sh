...
for spec in "round017-api3-gpt4o-en-disease round017_en-disease_N04068_P00001_plan.jsonl" "round017-api3-gpt4o-en-pest round017_en-pest_N05019_P00001_plan.jsonl"; do
  set -- $spec
