...
run_dir=outputs/runs/rag/rag-sft-round112-option-finalization-smoke/logs
mkdir -p "$run_dir"
set -a
...
.venv/bin/python -m tools.rag_distill.run_pilot \
  ...
  --output-dir outputs/experiments/rag_sft_iteration/candidates/round112-option-finalization-smoke/pilot \
