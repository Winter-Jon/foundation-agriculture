...
"$PYTHON_BIN" src/agrinet/vlm/evaluation/paired_bootstrap.py --candidate "$EVAL_ROOT/candidate_direct/scored.jsonl" --baseline "$EVAL_ROOT/raw_base_direct/scored.jsonl" --out "$EVAL_ROOT/candidate_vs_base_direct_paired_review.json" --bootstrap-samples 10000 --seed 20260819
"$PYTHON_BIN" src/agrinet/vlm/evaluation/paired_bootstrap.py --candidate "$EVAL_ROOT/candidate_rag/scored.jsonl" --baseline "$EVAL_ROOT/raw_base_rag/scored.jsonl" --out "$EVAL_ROOT/candidate_vs_base_rag_paired_review.json" --bootstrap-samples 10000 --seed 20260819
