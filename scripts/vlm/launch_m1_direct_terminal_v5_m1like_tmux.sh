#!/usr/bin/env bash
# Launch exactly one managed M1-like terminal-v5 train-and-evaluate queue in tmux.
set -euo pipefail
REPO_ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/../.." && pwd)"
cd "$REPO_ROOT"
EXPERIMENT_ID="vlm-sft-qwen3vl4b-m1-direct-current-hcv-terminal-v5-m1like-8gpu-v1"
SESSION="m1_direct_terminal_v5_m1like"
