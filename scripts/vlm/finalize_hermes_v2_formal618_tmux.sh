...
.venv/bin/python src/agrinet/vlm/evaluation/paired_bootstrap.py --candidate "$ROOT/candidate_direct/scored.jsonl" --baseline "$ROOT/base_direct/scored.jsonl" --out "$ROOT/candidate_vs_base_direct_paired_review.json" --bootstrap-samples 10000 --seed 20260819
.venv/bin/python src/agrinet/vlm/evaluation/paired_bootstrap.py --candidate "$ROOT/candidate_rag/scored.jsonl" --baseline "$ROOT/base_rag/scored.jsonl" --out "$ROOT/candidate_vs_base_rag_paired_review.json" --bootstrap-samples 10000 --seed 20260819
