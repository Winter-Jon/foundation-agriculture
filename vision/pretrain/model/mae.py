...
class MaskedAutoencoderViT(nn.Module):
    """Masked Autoencoder with a ViT encoder."""
...
def mae_vit_base_patch16_224(**kwargs):
    model_args = dict(
        img_size=224,
        patch_size=16,
        embed_dim=768,
...
def mae_vit_huge_patch14_224(**kwargs):
    """Standard MAE ViT-H/14 encoder with the lightweight MAE decoder."""
    model_args = dict(
        img_size=224,
        patch_size=14,
        embed_dim=1280,
